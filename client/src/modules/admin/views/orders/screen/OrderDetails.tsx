      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <div className="my-4 flex justify-between items-center">
            <span>
              Order ID:{" "}
              <span className="font-semibold">{orderPayload?.refID}</span>
            </span>
          ...
          <div className="">
            <h2 className="text-[18px] font-semibold mt-8 mb-2">
              Order Details
            </h2>
            ...
            <div className="bg-white p-4 rounded-[5px] ">
              ...
              <div className=" rounded-[5px] ">
                <div className="flex flex-col  justify-between items-start my-2 mb-4 pb-2 border-b border-gray-200">
        ...
        <div className="bg-white rounded-[5px] mt-[109px]"></div>
      </div>
    </div>
  );
};
